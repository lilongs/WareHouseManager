...
namespace BULayer
{
    ...
    {
        DALModuleInfo dal = new DALModuleInfo();
            /// <summary>
        /// 得到最大ID
        /// </summary>
        public int GetMaxId()
       ...
       /// <returns></returns>
        ...
        {
            return dal.AddModuleInfo(paramModeName,  paramFormName,  paramParentID, Sort);
        }
        ...
        {
            return dal.UpdateModuleInfo(paramID,  paramModeName,  paramFormName, paramParentID,Sort);
        }
    }
}
