...
namespace InventoryManagersystem
{
    public partial class Frmmain : Form
    {
        ...
        private void Frmmain_Load(object sender, EventArgs e)
        {
            ...
            string theHelpFile;
            if (File.Exists(theHelpFile = Application.StartupPath + @"\操作指导说明.pdf"))
                mainHelp.HelpNamespace = theHelpFile;
            mainHelp.SetShowHelp(this, true);
            // begin 
            #region 首页默认页
        ...
        {
            frmAboutBox myfrmAboutBox = new frmAboutBox();
            myfrmAboutBox.ShowDialog();
        }
